"""
Бот копирует FSM_example_bot.py,
НО с использованием системы управления базами данных Redis.

Добавляем модули
from aiogram.fsm.storage.redis import Redis, RedisStorage
И вносим 2 изменения
"""
...
from aiogram.fsm.storage.redis import Redis, RedisStorage
from aiogram.types import InlineKeyboardButton, InlineKeyboardMarkup, Message, PhotoSize, CallbackQuery
